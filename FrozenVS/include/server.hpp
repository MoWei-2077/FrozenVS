...
public:
    ...
    void serverThreadFunc() {
        ...
        const sockaddr_in serv_addr{ AF_INET, htons(60911), {inet_addr("127.0.0.1")}, {} };
    ...
    void handleCmd(const MANAGER_CMD appCommand, const int recvLen, const int clnt_sock) {
        ...
        case MANAGER_CMD::getPropInfo: {
            ...
            replyLen = snprintf(replyBuf.get(), REPLY_BUF_SIZE,
                ...
                freezeit.androidVerStr.c_str(), freezeit.kernelVerStr.c_str(), freezeit.extMemorySize);
        } break;
        ...
        case MANAGER_CMD::getXpLog: {
            ...
            if (len == 0) {
                ...
                replyPtr = (char*)("Frozen's Xposed log is empty. ");
                replyLen = 32;
            }
            else {
                replyPtr = replyBuf.get();
        ...
        case MANAGER_CMD::getAppCfg: {
            ...
            for (const auto& appInfo : managedApp.appInfoMap) {
                ...
                ptr[intCnt++] = (int)(appInfo.freezeMode);
        ...
        case MANAGER_CMD::setAppCfg: {
            ...
            for (const auto& appInfo : managedApp.appInfoMap) {
                ...
                tips.append(freezer.getModeText(appInfo.freezeMode)) 
                    .append("->")
                    .append(freezer.getModeText(newCfg[appInfo.uid].freezeMode))
                    .append(" [")
                    .append(appInfo.label) 
                    .append("]\n");
            }
            if (tips.length())
